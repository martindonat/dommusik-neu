...
function buildIssueTemplate({
  ...
  } else if (typeof "3.16.0" === 'string') {
    version = `decap-cms-app@${"3.16.0"}`;
  }
...
function RecoveredEntry({
  ...
  return _jsxs(_Fragment, {
    children: [_jsx("hr", {}), _jsx("h2", {
      children: t('ui.errorBoundary.recoveredEntry.heading')
    }), _jsx("strong", {
      children: t('ui.errorBoundary.recoveredEntry.warning')
    }), _jsx(CopyButton, {
      onClick: () => navigator.clipboard.writeText(entry),
      children: t('ui.errorBoundary.recoveredEntry.copyButtonLabel')
    }), _jsx("pre", {
      children: _jsx("code", {
        children: entry
      })
...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    return _jsxs(ErrorBoundaryContainer, {
      children: [_jsx("h1", {
        children: t('ui.errorBoundary.title')
      }), _jsxs("p", {
        children: [_jsx("span", {
          children: t('ui.errorBoundary.details')
        }), _jsx("a", {
          href: buildIssueUrl({
            title: errorTitle,
          ...
          children: t('ui.errorBoundary.reportIt')
        })]
      }), _jsx("p", {
        children: t('ui.errorBoundary.privacyWarning').split('\n').map((item, index) => _jsxs(_Fragment, {
          children: [_jsx(PrivacyWarning, {
            children: item
          }, index), _jsx("br", {})]
        }))
      }), _jsx("hr", {}), _jsx("h2", {
        children: t('ui.errorBoundary.detailsHeading')
      }), _jsx("p", {
        children: errorMessage
      }), backup && showBackup && _jsx(RecoveredEntry, {
        entry: backup,
        t: t
      })]
    });
